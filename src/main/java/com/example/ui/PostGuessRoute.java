...
public class PostGuessRoute implements Route {
  ...
  static final String LOW_GUESS = "The number is higher than your guess";
  static final String HIGH_GUESS = "The number is lower than your guess";
  ...
  public String handle(Request request, Response response) {
    ...
    if(playerServices != null) {
      ...
      switch (playerServices.makeGuess(guess)) {
        ...
        case WRONG:
          vm.put(GetGameRoute.GUESSES_LEFT_ATTR, playerServices.guessesLeft());
          if(playerServices.guessesLeft() > 0) {
            mv = error(vm, playerServices.hint(guess));
          }else{
